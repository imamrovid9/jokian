            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header">
                    <div class="d-flex justify-content-between">
                        <div class="logo">
                            <a href="{{ route('admin.home') }}">Admin Area</a>
                        </div>
                        <div class="toggler">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item @if(Request::is('admin/home')) active @endif">
                        ...
                        <li class="sidebar-item @if(Request::is('admin/article')) active @endif">
                            <a href="{{ route('admin.addarticle') }}" class='sidebar-link'>
                                <i class="bi bi-grid-fill"></i>
                                <span>Article</span>
                            </a>
                        </li>

                        <li class="sidebar-item @if(Request::is('admin/people')) active @endif">
                            <a href="{{ route('admin.people') }}" class='sidebar-link'>
                                <i class="bi bi-grid-fill"></i>
